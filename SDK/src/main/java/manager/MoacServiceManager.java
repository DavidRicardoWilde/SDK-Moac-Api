...
import org.chain3j.protocol.ipc.IpcService;
...
public class MoacServiceManager {
    private static final Logger log = LoggerFactory.getLogger(MoacServiceManager.class);
     ...
     * @throws McException
     */
    public McResponse mc_register(String password, String token) throws IOException, McException{
